...
True Type Font: Wide Pixel-7 version 1.0


EULA
-==-
The font Wide Pixel-7 is freeware for home use only.


DESCRIPTION
-=========-
Original wide pixel font. Size of base symbol is 7*5 pixels. Latin and Cyrillic code pages are supported.

Files in wide_pixel-7.zip:
       	readme.txt     			this file.
        wide_pixel-7.ttf    		regular font
	wide_pixel-7_screen.png		preview image
